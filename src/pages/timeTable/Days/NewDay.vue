        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-between">
              <div class="col-md-6">
                <div class="page-title-content">
                  <h3>{{ dayType }} Day</h3>
                  <p class="mb-2">Welcome to TimetableApp {{ dayType }} Day page</p>
                </div>
              </div>
              <div class="col-auto">
          ...
          <div class="row">
            <div class="col-12">
              <div class="cc-card">
                <div
                  class="cc-card-title d-flex justify-content-between align-items-center"
                >
                  <h5>{{ dayType }} Day</h5>
                ...
                <div class="cc-card-body">
                  <form @submit.prevent="onCreateDay" method="post">
                    ...
                    <div class="mt-16">
                      <button type="submit" class="btn btn-primary mr-2">{{ dayType }}</button>
                    </div>
                  </form>
                </div>
              </div>
...
import { CREATE_NEW_DAY, UPDATE_NEW_DAY } from "../../../store/TimetableConstants";
export default {
  created() {
      if (this.$route.query.id && this.$route.query.name && this.$route.query.description) {
