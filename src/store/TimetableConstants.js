...
export const GET_PERIOD_OF_DAY = '[action] get period of day';
export const GET_CURRENT_DAY = '[getter] get current day';
export const SET_CURRENT_DAY = '[mutation] set current day';
export const AUTO_GET_DAY = '[action] auto get day';
